...
/**
 * Filter that intercepts every HTTP request, reads the JWT from the
 * Authorization header, validates it, and sets the authentication in
 * the SecurityContext so that Spring Security allows the request.
 */
@Component
